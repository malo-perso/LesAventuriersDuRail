...
public class FrameCreation extends JFrame implements ActionListener {
    ...
    public FrameCreation(){
        ...
        this.imgLogo = kit.getImage("../images/logo.png") ;
        ...
        this.menuRegles.setIcon( new ImageIcon( "../images/Regles.png"   ) );
        ...
        this.reglePDF = new File("../PDF/Regles.pdf");
    ...
    public static void main(String[] arg){new FrameCreation();}
